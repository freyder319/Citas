...
<title>Sistema de Gestión Odontológica</title>
 ...
 <div id="contenido">
    ...
    <form action="index.php?accion=guardarModificacionConsultorio" method="POST">
        <input type="hidden" name="id" value="<?php echo $consultorio['ConNumero']; ?>">
        <label>Nombre:</label>
        <input type="text" name="nombre" value="<?php echo $consultorio['ConNombre']; ?>" required>
        <br>
        <br>
