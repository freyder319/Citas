...
<body>
            ...
            <form id="frmasignar" action="index.php?accion=guardarCita" method="post">
                <table>
                    ...
                    <tr>
                        ...
                        <option value="-1" selected="selected">---Selecione el Consultorio</option><?php
                    ...
                    <tr>
                        <td colspan="2">
                        <input type="submit" name="asignarEnviar" value="Enviar" id="asignarEnviar" onclick="validar()">
                    </td>
                    </tr>
                </table>
            </form>
    ...
    <table>
        ...
        <tr>
            <td>Sexo</td>
            <td><select id="pacSexo" name="PacSexo"><option value="-1"selected="selected">--Selecione el sexo ---</option><option value="M">Masculino</option><option value="F">Femenino</option></select>
            </td>
        </tr>
    </table>
    </form>
